...
def update_access_token():
    return determine_wrapper(mpCommon.update_access_token, None)

def access_token(fn):
    return determine_wrapper(mpCommon.access_token, None,
        fn)

def get_server_ip():
    return determine_wrapper(mpCommon.get_server_ip, None)

def filter_request(request):
    return determine_wrapper(mpCommon.filter_request, None,
        request)
